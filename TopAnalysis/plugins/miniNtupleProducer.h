#ifndef miniNtupleProducer_h
#define miniNtupleProducer_h
...
class miniNtupleProducer : public edm::EDAnalyzer 
{
  public:
    typedef reco::Particle::LorentzVector LorentzVector;
    explicit miniNtupleProducer(edm::ParameterSet const& cfg);
    virtual void beginJob();
    virtual void beginRun(edm::Run const& iRun, edm::EventSetup const& iSetup);
    virtual void endRun(edm::Run const& iRun, edm::EventSetup const& iSetup);
    virtual void analyze(edm::Event const& iEvent, edm::EventSetup const& iSetup);
    virtual void endJob();
    virtual ~miniNtupleProducer();
  ...
  private:  
    ...
    float rho_,met_,metSig_,ht_,pvRho_,pvz_,pvndof_,pvchi2_,metGenSig_;
