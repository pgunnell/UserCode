...
class nanoNtupleProducerCandidates : public edm::EDAnalyzer 
{
  ...
  private:  
    ...
    bool   isMC_,isPrint_,saveWeights_,debug_,mHigherOrder_; 
    //---------------------------------------------------
    ...
    std::vector<float> *cor_, *unc_,*pt_,*eta_,*phi_,*mass_,*massSoftDrop_,*energy_,*chf_,*nhf_,*phf_,*elf_,*muf_,*btag_,*tau1_,*tau2_,*tau3_,*npr_,*chm_;
