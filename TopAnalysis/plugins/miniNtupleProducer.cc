...
#include "KKousour/TopAnalysis/plugins/miniNtupleProducer.h"

using namespace std;
using namespace reco;
using namespace fastjet;

miniNtupleProducer::miniNtupleProducer(edm::ParameterSet const& cfg)
{ 
...
//////////////////////////////////////////////////////////////////////////////////////////
void miniNtupleProducer::beginJob() 
{
...
//////////////////////////////////////////////////////////////////////////////////////////
void miniNtupleProducer::endJob() 
{  
  delete isBtag_;
  delete flavor_;
...
//////////////////////////////////////////////////////////////////////////////////////////
void miniNtupleProducer::beginRun(edm::Run const& iRun, edm::EventSetup const& iSetup) 
{
  if (isMC_ && debug_) {
...
//////////////////////////////////////////////////////////////////////////////////////////
void miniNtupleProducer::endRun(edm::Run const& iRun, edm::EventSetup const& iSetup) 
{
}
//////////////////////////////////////////////////////////////////////////////////////////
bool miniNtupleProducer::isGoodJet(const pat::Jet &jet)
{
...
//////////////////////////////////////////////////////////////////////////////////////////
float miniNtupleProducer::getPFMiniIsolation(edm::Handle<pat::PackedCandidateCollection> pfcands,const reco::Candidate *cand)
{
...
//////////////////////////////////////////////////////////////////////////////////////////
bool miniNtupleProducer::isGoodMuon(const pat::Muon &mu,edm::Handle<pat::PackedCandidateCollection> pfcands)
{
  bool res = true; // by default is good, unless fails a cut bellow
...
//////////////////////////////////////////////////////////////////////////////////////////
bool miniNtupleProducer::isGoodElectron(const pat::Electron &el,const reco::Vertex &vtx,edm::Handle<pat::PackedCandidateCollection> pfcands)
{
  bool res = true; // by default is good, unless fails a cut bellow
...
//////////////////////////////////////////////////////////////////////////////////////////
void miniNtupleProducer::analyze(edm::Event const& iEvent, edm::EventSetup const& iSetup) 
{
  initialize();
...
//////////////////////////////////////////////////////////////////////////////////////////
void miniNtupleProducer::initialize()
{
  dPhiLJ_         = -1;
  dPhiJJ_         = -1;
  dRJJ_           = -1;
...
//////////////////////////////////////////////////////////////////////////////////////////
miniNtupleProducer::~miniNtupleProducer() 
{
}

DEFINE_FWK_MODULE(miniNtupleProducer);
