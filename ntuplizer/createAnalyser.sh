...
sed -e 's;ANALYSER_TEMPL;'${ananame}';g' < $src/ANALYSER_TEMPL.h > /afs/cern.ch/work/p/pgunnell/DelphesAnalysis/ntuplizer/interface/${ananame}.h
sed -e 's;ANALYSER_TEMPL;'${ananame}';g' < $src/ANALYSER_TEMPL.cpp > /afs/cern.ch/work/p/pgunnell/DelphesAnalysis/ntuplizer/src/${ananame}.cpp
sed -e 's;ANALYSER_TEMPL;'${ananame}';g' < $src/ANALYSER_TEMPL_EXEC.cpp > /afs/cern.ch/work/p/pgunnell/DelphesAnalysis/ntuplizer/bin/${ananame}.cpp
